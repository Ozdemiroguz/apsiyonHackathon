...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/indir.png
  AssetGenImage get indir => const AssetGenImage('assets/images/indir.png');

  /// File path: assets/images/konfeti.png
  AssetGenImage get konfeti => const AssetGenImage('assets/images/konfeti.png');

  /// File path: assets/images/kurye.png
  AssetGenImage get kurye => const AssetGenImage('assets/images/kurye.png');

  /// File path: assets/images/meeting.png
  AssetGenImage get meeting => const AssetGenImage('assets/images/meeting.png');

  /// File path: assets/images/odeabank_kampanya.png
  AssetGenImage get odeabankKampanya =>
      const AssetGenImage('assets/images/odeabank_kampanya.png');
  ...
  /// File path: assets/images/statusback.jpeg
  AssetGenImage get statusback =>
      const AssetGenImage('assets/images/statusback.jpeg');
