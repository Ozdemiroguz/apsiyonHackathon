...
import 'package:apsiyonY/features/conference/presentation/providers/meeting_home_providers.dart';
import 'package:apsiyonY/router/router.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        separatorBuilder: (context, index) => SizedBox(width: 15.h),
        scrollDirection: Axis.horizontal,
        itemCount: state.meetingListPast.length,
        itemBuilder: (context, index) {
          return _MeetingCard(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        notifier.setStatus(meeting.meetingID, "active");

                        ref.read(meetingHomeProvider).failure.fold(
                              () => const CustomDialog.success(
                                title: "Başarılı",
                                subtitle: "Toplantı Aktif Edildi",
                              ).show(context),
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        notifier.setStatus(meeting.meetingID, "deleted");

                        ref.read(meetingHomeProvider).failure.fold(
                              () => const CustomDialog.success(
                                title: "Başarılı",
                                subtitle: "Toplantı Silindi",
                              ).show(context),
                              (a) => CustomDialog.failure(
                                title: "Hata",
                                subtitle: a.message,
                  ...
                  Expanded(
                    child: CustomFilledButton(
                      ...
                      onPressed: () {
                        ...
                        notifier.setStatus(meeting.meetingID, "past");

                        ref.read(meetingHomeProvider).failure.fold(
                              () => const CustomDialog.success(
                                title: "Başarılı",
                                subtitle: "Toplantı Bitirildi",
                              ).show(context),
                              (a) => CustomDialog.failure(
                                title: "Hata",
                                subtitle: a.message,
