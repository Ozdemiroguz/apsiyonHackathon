...
import '../../services/network/network_service.dart' as _i30;
import '../../services/network/network_service_impl.dart' as _i31;
import '../../services/user_service/user_service.dart' as _i28;
import '../../services/user_service/user_service_impl.dart' as _i29;
import '../models/usecases/base_64_encode.dart' as _i25;
import '../models/usecases/usecase.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i13.MeetingRepository>(
        () => _i14.MeetingRepositoryImpl(gh<_i10.FirebaseFirestore>()));
    gh.lazySingleton<_i15.NetworkInfo>(
        () => _i16.NetworkInfoImpl(connectivity: gh<_i8.Connectivity>()));
    ...
    gh.lazySingleton<_i23.UseCase<String, _i24.Uint8List>>(
        () => const _i25.Base64Encode());
    gh.lazySingleton<_i26.OtherRepository>(
        () => _i27.OtherRepositoryImpl(gh<_i10.FirebaseFirestore>()));
    gh.lazySingleton<_i28.UserService>(() => _i29.UserServiceImpl(
          gh<_i10.FirebaseFirestore>(),
          gh<_i9.FirebaseAuth>(),
        ));
    gh.lazySingleton<_i30.NetworkService>(() => _i31.NetworkServiceImpl(
          gh<_i12.Dio>(),
